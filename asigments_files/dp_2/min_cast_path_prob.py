...
def minCostPath(input, mRows, nCols, i , j) :
    ...
    c = input[i][j]
    c1 = minCostPath(input, mRows, nCols, i, j + 1)
    c2 = minCostPath(input, mRows, nCols, i + 1, j)
    c3 = minCostPath(input, mRows, nCols, i + 1, j + 1)
