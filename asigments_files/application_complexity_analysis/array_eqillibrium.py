...
def arrayEquilibriumIndex(arr, n, i, sumLeft,sumRight) :
    if i > n-1:
        return -1
    if sumLeft == sumRight:
        return i
        ...
        if i+1 < n-1:
            ...
            sumRight = 0
        return arrayEquilibriumIndex(arr, n, i+1, sumLeft+arr[i], sumRight)
...
while t > 0 :
    ...
    sumLeft = 0
    sumRight = sum(arr[1:])
    print(arrayEquilibriumIndex(arr, n,i, sumLeft, sumRight))
